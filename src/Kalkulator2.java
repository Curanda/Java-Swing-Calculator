...
public class Kalkulator2 extends JFrame {
    ...
    public Kalkulator2() {
        JFrame kalkulator = new JFrame("Kalkulator OMEGA");
        ...
        // Zrobiłem to programatycznie, bo straszne spaghetti wychodzi z tego dodawania klawiatury numerycznej.
        ...
        pole.setPreferredSize(new Dimension(200, 30));
        ...
        pole.setBorder(compoundBorder);
        pole.setEditable(false);
        kalkulator.add(new JPanel().add(pole), BorderLayout.PAGE_START);
        ...
        OperacjaKalkulatora2 listener = new OperacjaKalkulatora2(pole, bPlus, bMinus, bRazy, bDziel, bRowna, bKropka, bKasuj, listaNumerow, bPM);
